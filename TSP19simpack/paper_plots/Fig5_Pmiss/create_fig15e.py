...
if True:
    ...
    fig_handle1 = pl.load(open('relax/fig_pmiss-rob1/plot10.pickle','rb'))
    fig_handle2 = pl.load(open('relax/fig_pmiss-rob2/plot10.pickle','rb'))
    fig_handle3 = pl.load(open('relax/fig_pmiss-rob8/plot10.pickle','rb'))
    fig_handle4 = pl.load(open('mle/fig_pmiss-rob8/plot10.pickle','rb'))

    fig_handle1b = pl.load(open('relax/fig_pmiss-rob1/plot3.pickle','rb'))
    fig_handle2b = pl.load(open('relax/fig_pmiss-rob2/plot3.pickle','rb'))
    fig_handle3b = pl.load(open('relax/fig_pmiss-rob8/plot3.pickle','rb'))
    fig_handle4b = pl.load(open('mle/fig_pmiss-rob8/plot3.pickle','rb'))    
