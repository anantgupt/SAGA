...
if True:
    ...
    for i in range(2):
        for j in range(2):
            if j==0:
                fha[i][0] = pl.load(open('relax/fig_Nob-rob'+si[i]+'/plot1.pickle','rb'))
                fha[i][1] = pl.load(open('relax/fig_Nob-rob'+si[i]+'/plot11.pickle','rb'))
                
            else:
                fha[i][2] = pl.load(open('mle/fig_Nob-rob'+si[i]+'/plot1.pickle','rb'))
                fha[i][3] = pl.load(open('mle/fig_Nob-rob'+si[i]+'/plot11.pickle','rb'))
    # fig_handle1 = pl.load(open('relax/fig_Nob-rob0/plot11.pickle','rb'))
    # fig_handle2 = pl.load(open('relax/fig_Nob-rob1/plot11.pickle','rb'))
    # fig_handle3 = pl.load(open('relax/fig_Nob-rob20/plot11.pickle','rb'))
    # fig_handle1b = pl.load(open('relax/fig_Nob-rob0/plot1.pickle','rb'))
    # fig_handle2b = pl.load(open('relax/fig_Nob-rob1/plot1.pickle','rb'))
    # fig_handle3b = pl.load(open('relax/fig_Nob-rob20/plot1.pickle','rb'))

    # fig_handle1aa = pl.load(open('mle/fig_Nob-rob0/plot11.pickle','rb'))
    # fig_handle2aa = pl.load(open('mle/fig_Nob-rob1/plot11.pickle','rb'))
    # fig_handle3aa = pl.load(open('mle/fig_Nob-rob20/plot11.pickle','rb'))
    # fig_handle1bb = pl.load(open('mle/fig_Nob-rob0/plot1.pickle','rb'))
    # fig_handle2bb = pl.load(open('mle/fig_Nob-rob1/plot1.pickle','rb'))
    # fig_handle4bb = pl.load(open('mle/fig_Nob-rob20/plot1.pickle','rb'))
