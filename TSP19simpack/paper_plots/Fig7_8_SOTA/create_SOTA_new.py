...
if True:
    ...
    pnos = [1,3,11]
    for pno in pnos:
        fig_handle1 = pl.load(open('results1214_8982mcf/fig_0.2Nob-pmiss'+pmiss_str+'/plot'+str(pno)+'.pickle','rb'))
        fig_handle2 = pl.load(open('results1213_17922mle/fig_0.2Nob-pmiss'+pmiss_str+'/plot'+str(pno)+'.pickle','rb'))

        fig_handle1d = pl.load(open('results1213_144569Relax/fig_0.2Nob-pmiss'+pmiss_str+'/plot'+str(pno)+'.pickle','rb'))
        fig_handle2d = pl.load(open('results1214_04628SPEKF/fig_0.2Nob-pmiss'+pmiss_str+'/plot'+str(pno)+'.pickle','rb'))
    ...
    ##############
    axaa.legend(loc='upper left'),axaa.grid(True);axaa.set_yscale('linear')
    ...
    fig3.savefig('SOTA_RTIME_vs_Card_comparison_vs_Nob'+Nss[Ns]+'.png')
    ##############
