...
if True:
    ...
    fig_handle1b = pl.load(open('SAESL/fig_Nob-snr-10/plot3.pickle','rb'))
    fig_handle2b = pl.load(open('SAESL/fig_Nob-snr-15/plot3.pickle','rb'))
    fig_handle3b = pl.load(open('SAESL/fig_Nob-snr0/plot3.pickle','rb'))
    
    fig_handle1 = pl.load(open('SAGA/fig_Nob-snr-10/plot3.pickle','rb'))
    fig_handle2 = pl.load(open('SAGA/fig_Nob-snr-15/plot3.pickle','rb'))
    fig_handle3 = pl.load(open('SAGA/fig_Nob-snr0/plot3.pickle','rb'))
