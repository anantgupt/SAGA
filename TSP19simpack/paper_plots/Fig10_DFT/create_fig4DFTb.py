...
if True:
    ...
    for i in idxa:
        ...
        # axa[1].plot(rng, r2d[i].get_data()[1], 'b--'+mkr[i+1], label='DFT Nsens=4 '+lbl2[i])
        axa.plot(rng, r4d[i].get_data()[1]/Navg, colr[i],linestyle=lst[i],marker=mkr[2], label=lbl2[i]+', DFT')
    # axa2 = axa.twinx()
