...
def cf4b(mode = 'Relax', width = 3.45, height = 2.6, font_size = 8):
    ...
    fig_handle1 = pl.load(open('fig_Nsens-rob0/plot11.pickle','rb'))
    fig_handle2 = pl.load(open('fig_Nsens-rob1/plot11.pickle','rb'))
    fig_handle3 = pl.load(open('fig_Nsens-rob2/plot11.pickle','rb'))
    fig_handle4 = pl.load(open('fig_Nsens-rob4/plot11.pickle','rb'))
    fig_handle1b = pl.load(open('fig_Nsens-rob0/plot1.pickle','rb'))
    fig_handle2b = pl.load(open('fig_Nsens-rob1/plot1.pickle','rb'))
    fig_handle3b = pl.load(open('fig_Nsens-rob2/plot1.pickle','rb'))
    fig_handle4b = pl.load(open('fig_Nsens-rob4/plot1.pickle','rb'))
    ...
    for i in range(4):
        ...
        ax.plot(rng, mse2[i], 'b-'+mkr[i], label=lbl[i]+r', $\rho=1$')
        ax.plot(rng, mse3[i], 'r-'+mkr[i], label=lbl[i]+r', $\rho=2$')
        ax.plot(rng, mse4[i], 'm-'+mkr[i], label=lbl[i]+r', $\rho=4$')
    ...
    for i in idxa:
        ...
        axa[1].plot(rng, r2[i].get_data()[1], 'r-'+mkr[i], label=r'$\rho=1$'+lbl2[i])
        axa[1].plot(rng, r3[i].get_data()[1], 'g-'+mkr[i], label=r'$\rho=2$ '+lbl2[i])
        axa[1].plot(rng, r4[i].get_data()[1], 'r-'+mkr[i], label=r'$\rho=4$'+lbl2[i])
    ...
    plt.tight_layout()
    pl.dump(fig, open("Sel_figs/plot_complexity_vs_Nsens-rob.pickle", "wb"))
    fig.savefig('Sel_figs/plot_complexity_vs_Nsens-rob.pdf')