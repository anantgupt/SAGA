...
def cf4c(mode = 'Relax', width = 3.45, height = 2.6, font_size = 8):
    ...
    fig_handle1 = pl.load(open('fig_Nob-rob0/plot11.pickle','rb'))
    fig_handle2 = pl.load(open('fig_Nob-rob1/plot11.pickle','rb'))
    fig_handle3 = pl.load(open('fig_Nob-rob2/plot11.pickle','rb'))
    fig_handle4 = pl.load(open('fig_Nob-rob20/plot11.pickle','rb'))
    fig_handle1b = pl.load(open('fig_Nob-rob0/plot1.pickle','rb'))
    fig_handle2b = pl.load(open('fig_Nob-rob1/plot1.pickle','rb'))
    fig_handle3b = pl.load(open('fig_Nob-rob2/plot1.pickle','rb'))
    fig_handle4b = pl.load(open('fig_Nob-rob20/plot1.pickle','rb'))
    ...
    #    crb1 = fig_handle1.axes[i].lines[1].get_data()[1]
        ...
        ax.plot(rng, mse4[i], 'm-'+mkr[i], label=lbl[i]+r', $\rho=\infty$')
    ...
    for i in idxa:
        ...
        axa[1].plot(rng, r4[i].get_data()[1], 'r-'+mkr[i], label=r'$\rho=\infty$'+lbl2[i])
