...
def cf1b(mode = 'Relax', width = 3.45, height = 2.6, font_size = 8):
    #fig_handle = pl.load(open('results6_14/fig_obj_est2/plot4.pickle','rb'))
    fig_handle1 = pl.load(open('fig_snr-Nob1/plot4.pickle','rb'))
    fig_handle2 = pl.load(open('fig_snr-Nob10/plot4.pickle','rb'))
    fig_handle3 = pl.load(open('fig_snr-Nob20/plot4.pickle','rb'))
    fig_handle4 = pl.load(open('fig_snr-Nob30/plot4.pickle','rb'))
...
#        ax[i].plot(rng, crb4, 'y--',label='CRB Nob=31')
    ...
    pl.dump(fig, open("Sel_figs/plot_RD_error.pickle", "wb"))
    fig.savefig('Sel_figs/plot_RD_error.pdf')
